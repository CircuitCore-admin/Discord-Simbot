...
SELECT 
    ...
    COALESCE(MIN(CASE WHEN si.session_type = 'Q' THEN dss.finishing_position END), 999) AS best_q_position,
    COALESCE(MIN(CASE WHEN si.session_type = 'R' THEN dss.finishing_position END), 999) AS best_r_position,
    COALESCE(AVG(CASE WHEN si.session_type = 'FP' THEN dss.average_valid_lap END), 0.0) AS average_valid_fp,
    COALESCE(AVG(CASE WHEN si.session_type = 'Q' THEN dss.average_valid_lap END), 0.0) AS average_valid_q,
    COALESCE(AVG(CASE WHEN si.session_type = 'R' THEN dss.average_valid_lap END), 0.0) AS average_valid_r,
    COALESCE(AVG(CASE WHEN si.session_type = 'FP' THEN dss.average_lap END), 0.0) AS average_fp,
    COALESCE(AVG(CASE WHEN si.session_type = 'Q' THEN dss.average_lap END), 0.0) AS average_q,
    COALESCE(AVG(CASE WHEN si.session_type = 'R' THEN dss.average_lap END), 0.0) AS average_r,
    COALESCE(MIN(CASE WHEN si.session_type = 'Q' THEN dss.fastest_lap END), 9999.9) AS fastest_q_lap,
    COALESCE(MIN(CASE WHEN si.session_type = 'R' THEN dss.fastest_lap END), 9999.9) AS fastest_r_lap,
    COALESCE(
    ...
    9999.9) AS fastest_possible_overall,
